...
// require 'aksi/functionPakar.php';
...
if (!isset($_GET['penyakit_berhasil_ditambah'])) {
    $penyakit_berhasil_ditambah = 0;
} else {
    $penyakit_berhasil_ditambah = $_GET['penyakit_berhasil_ditambah'];
}

if (!isset($_GET['penyakit_berhasil_diubah'])) {
    $penyakit_berhasil_diubah = 0;
} else {
    $penyakit_berhasil_diubah = $_GET['penyakit_berhasil_diubah'];
}

if (!isset($_GET['penyakit_berhasil_dihapus'])) {
    $penyakit_berhasil_dihapus = 0;
} else {
    $penyakit_berhasil_dihapus = $_GET['penyakit_berhasil_dihapus'];
}
?>
...
<body class="hold-transition sidebar-mini">
                            ...
                            <?php else : ?>
                                ...
                                <li class="nav-item has-treeview menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="lihat_penyakit.php" class="nav-link active">
                                                <i class="fas fa-list-ul nav-icon" style="font-size: 14px;"></i>
                                                <p style="font-size: 15.5px;">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Lihat Penyakit</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 110px;">Kode Penyakit</th>
                                                <th>Nama Penyakit</th>
                                                <th>Nama Latin</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($data = mysqli_fetch_assoc($result)) : ?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $data["kode_penyakit"]; ?>
                                                    </td>
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        <div class="btn-group btn-group-sm">
                                                            <a data-toggle="tooltip" data-placement="top" title="Lihat Detail Penyakit" href="detail_penyakit.php?id=<?= $data["id"]; ?>" class="btn btn-success">
                                                                <i class="fas fa-eye"></i>
                                                                Lihat</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Ubah Data Penyakit" href="ubah_penyakit.php?id=<?= $data["id"]; ?>" class="btn btn-warning">
                                                                <i class="fas fa-edit"></i>
                                                                Ubah</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Hapus Data Penyakit" href="aksi/hapus_penyakit.php?id=<?= $data["id"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus?');" class="btn btn-danger">
                                    ...
                                    <a href="tambah_penyakit.php">
                                        <button class="btn btn-info">Tambah Penyakit</button>
                                    </a>
                                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var penyakit_berhasil_ditambah = <?php echo json_encode($penyakit_berhasil_ditambah); ?>;
            if (penyakit_berhasil_ditambah > 0) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data Penyakit Berhasil Ditambahkan, Terimakasih!'
                    })
                });
            }

            var penyakit_berhasil_diubah = <?php echo json_encode($penyakit_berhasil_diubah); ?>;
            if (penyakit_berhasil_diubah > 0) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data Penyakit Berhasil Diubah, Terimakasih!'
                    })
                });
            }

            var penyakit_berhasil_dihapus = <?php echo json_encode($penyakit_berhasil_dihapus); ?>;
            if (penyakit_berhasil_dihapus > 0) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data Penyakit Berhasil Dihapus, Terimakasih!'
                    })
                });
            }
        });
