    ...
    if ($usernamelama == $username) {
        ...
        if (empty($data['password'])  && empty($data['password2'])) {
            ...
            if (mysqli_affected_rows($koneksi) > 0) {
                ...
                header("location:../profil.php?pakar_berhasil_diubah=" . $pakar_berhasil_diubah);
            } else {
                //username ga di ganti dan pw ga di ganti

                $pakar_berhasil_diubah = 2;
                header("location:../ubah_profil.php?id=" . $id . "&&pakar_berhasil_diubah=" . $pakar_berhasil_diubah);
        ...
        {
            echo "<script> alert('username yang anda masukkan sudah terdaftar, silahkan gunakan username yang lain');
            history.go(-1);
            </script> ";
        } else {
