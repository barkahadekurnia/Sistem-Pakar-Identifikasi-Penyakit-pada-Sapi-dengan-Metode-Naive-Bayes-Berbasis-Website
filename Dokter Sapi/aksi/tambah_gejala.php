...
if (isset($_POST["submit"])) {
    if (tambah($_POST) > 0) {
        ...
        //     ";
        $gejala_berhasil_ditambah = 1;
        header("location:../lihat_gejala.php?gejala_berhasil_ditambah=" . $gejala_berhasil_ditambah);
...
function tambah($data)
{
    ...
    global $koneksi;
    global $kode_gejala;
    // Simpan data yang di inputkan  ke masing-masing variable
    // dan convert semua tag HTML yang mungkin dimasukkan untuk mengindari XSS
    $nama_gejala = htmlentities($data["nama_gejala"]);
