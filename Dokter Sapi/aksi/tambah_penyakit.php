...
if (isset($_POST["submit"])) {
    if (tambah($_POST) > 0) {
        ...
        $penyakit_berhasil_ditambah = 1;
        header("location:../lihat_penyakit.php?penyakit_berhasil_ditambah=" . $penyakit_berhasil_ditambah);
...
function tambah($data)
{
    ...
    $nama_penyakit = htmlentities($data["nama_penyakit"]);
    $nama_latin = htmlentities($data["nama_latin"]);
