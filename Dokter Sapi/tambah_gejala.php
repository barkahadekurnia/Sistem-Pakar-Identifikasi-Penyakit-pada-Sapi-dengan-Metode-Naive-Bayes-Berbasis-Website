                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column  nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <?php else : ?>
                                ...
                                <li class="nav-item has-treeview menu-open">
                                    ...
                                    <ul class="nav nav-treeview ">
                                        <li class="nav-item">
                                            <a href="tambah_gejala.php" class="nav-link active">
                                                <i class="fas fa-plus-circle nav-icon" style="font-size: 14px;"></i>
                                                <p style="font-size: 15.5px;">
                                                    Tambah Data Gejala
                                                </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <form role="form" action="aksi/tambah_gejala.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label class="col-sm-4 text-right" for="nama_gejala">Nama Gejala :</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="nama_gejala" id="nama_gejala" placeholder="Nama Penyakit" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 text-right" class="col-sm-3 text-right" for="gambar"> Gambar Gejala : </label>
                                    ...
                                    <div class="card-footer">
                                        <div class="row justify-content-center">
                                            <button type="submit" name="submit" class="btn btn-info float-right">Tambah Data Gejala</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
