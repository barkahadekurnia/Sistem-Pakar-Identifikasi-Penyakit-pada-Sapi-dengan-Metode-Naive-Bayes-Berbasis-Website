                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Data Pakar</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <div class="card-body">
                                    <form class="form-horizontal" role="form" action="aksi/ubah_pakar.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right" for="username">Nama Pakar:</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-sm-12">
                                                    <a href="lihat_pakar.php">
                                                        <button type="button" class="btn btn-secondary float-right">Batal Ubah</button>
                                                    </a>
                                                    <button type="submit" name="submit" class="btn btn-info float-left">Ubah Data Pakar</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
        ...
        $(function() {
            ...
            if (pakar_berhasil_diubah == 2) {
                ...
                $(function() {
                    Toast.fire({
                        icon: 'error',
                        title: 'Data Pakar tidak Ubah, Silahkan Coba Lagi!'
                    })
                });
            }
