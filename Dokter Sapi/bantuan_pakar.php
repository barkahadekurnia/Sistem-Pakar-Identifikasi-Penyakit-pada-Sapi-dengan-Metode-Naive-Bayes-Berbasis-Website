                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column  nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <?php else : ?>
                                ...
                                <li class="nav-item">
                                    <a href="bantuan_pakar.php" class="nav-link active">
                                        <i class="nav-icon fas fa-info-circle"></i>
                                        <p>
                                            Bantuan
                                        </p>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Bantuan <?php echo $_SESSION['level']; ?></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid pt-2" id="bantuan">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card card-info card-outline collapsed-card">
                                <div class="card-header" data-card-widget="collapse">
                                    <h2 class="float-left"><i>Cara Mengolah Data Penyakit :</i></h2>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-12 col-md-4 p-3">
                                            <h3 class="">Cara menambah data penyakit &nbsp;</h3>
                                            <div class="text-center pb-2">
                                                <img class="img-thumbnail" src="images/bantuan/pakar/tambah penyakit.png" style="height:250px; display:block;border: 0px;">
                                            </div>
                                            <p>Anda dapat menambahkan penyakit dengan cara masuk ke halaman tambah penyakit<a href="tambah_penyakit.php">
                                                    <span style="font-weight: bold; color:#17a2b8;">"Tambah penyakit"</span></a>yang ada pada sidebar disamping. </p>
                                        </div>
                                        <div class="col-sm-12 col-md-4 p-3" style="border-left: 1px solid rgb(0,0,0,.125); border-right: 1px solid rgb(0,0,0,.125);">
                                            <h3 class="">Cara melihat daftar penyakit&nbsp; </h3>
                                            <div class="text-center pb-2">
                                                <img class="img-thumbnail" src="images/bantuan/pakar/lihat daftar penyakit.png" style="height:250px; display:block;border: 0px;">
                                            </div>
                                            <p>Untuk melihat daftar penyakit pertama anda bisa menekan menu data penyakit yang ada pada sidebar disamping
                                            </p>
                                            <p>Kemudian, masuk kehalaman lihat daftar penyakit dengan cara menekan menu
                                                <a href="lihat_penyakit.php"><span style="font-weight: bold; color:#17a2b8;">"Lihat daftar penyakit"</span></a> yang ada pada sidebar
                                            </p>
                                        </div>
                                        <div class="col-sm-12 col-md-4 p-3">
                                            <h3 class="">Cara mengubah dan menghapus data penyakit</h3>
                                            <div class="text-center pb-2">
                                                <img class="img-thumbnail" src="images/bantuan/pakar/ubah dan hapus penyakit.png" style="height:250px; display:block;border: 0px;">
                                            </div>
                                            <p>Untuk mengubah dan menghapus data penyakit anda bisa melakukannya melalui halaman lihat daftar penyakit
                                            </p>
                                            <p>Anda bisa mengubah data penyakit dengan cara menekan tombol
                                                <span style="font-weight: bold; color:#17a2b8;">"Ubah"</span> yang ada pada tabel daftar penyakit
                                            </p>
                                            <p>Anda bisa menghapus data penyakit dengan cara menekan tombol
                                                <span style="font-weight: bold; color:#17a2b8;">"Hapus"</span> yang ada pada tabel daftar penyakit
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container-fluid pt-2" id="bantuan">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card card-info card-outline collapsed-card">
                                <div class="card-header" data-card-widget="collapse">
                                    <h2 class="float-left"><i>Cara Mengolah Data Gejala :</i></h2>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-12 col-md-4 p-3">
                                            <h3 class="">Cara menambah data gejala &nbsp;</h3>
                                            <div class="text-center pb-2">
                                                <img class="img-thumbnail" src="images/bantuan/pakar/tambah gejala.png" style="height:250px; display:block;border: 0px;">
                                            </div>
                                            <p>Anda dapat menambahkan gejala dengan cara masuk ke halaman tambah gejala<a href="tambah_gejala.php">
                                                    <span style="font-weight: bold; color:#17a2b8;">"Tambah gejala"</span></a>yang ada pada sidebar disamping. </p>
                                        </div>
                                        <div class="col-sm-12 col-md-4 p-3" style="border-left: 1px solid rgb(0,0,0,.125); border-right: 1px solid rgb(0,0,0,.125);">
                                            <h3 class="">Cara melihat daftar gejala </h3>
                                            <div class="text-center pb-2">
                                                <img class="img-thumbnail" src="images/bantuan/pakar/lihat daftar gejala.png" style="height:250px; display:block;border: 0px;">
                                            </div>
                                            <p>Untuk melihat daftar gejala pertama anda bisa menekan menu data gejala yang ada pada sidebar disamping
                                            </p>
                                            <p>Kemudian, masuk kehalaman lihat daftar gejala dengan cara menekan menu
                                                <a href="lihat_gejala.php"><span style="font-weight: bold; color:#17a2b8;">"Lihat daftar gejala"</span></a> yang ada pada sidebar
                                            </p>
                                        </div>
                                        <div class="col-sm-12 col-md-4 p-3">
                                            <h3 class="">Cara mengubah dan menghapus data gejala</h3>
                                            <div class="text-center pb-2">
                                                <img class="img-thumbnail" src="images/bantuan/pakar/ubah dan hapus gejala.png" style="height:250px; display:block;border: 0px;">
                                            </div>
                                            <p>Untuk mengubah dan menghapus data gejala anda bisa melakukannya melalui halaman lihat daftar gejala
                                            </p>
                                            <p>Anda bisa mengubah data gejala dengan cara menekan tombol
                                                <span style="font-weight: bold; color:#17a2b8;">"Ubah"</span> yang ada pada tabel daftar gejala
                                            </p>
                                            <p>Anda bisa menghapus data gejala dengan cara menekan tombol
                                                <span style="font-weight: bold; color:#17a2b8;">"Hapus"</span> yang ada pada tabel daftar gejala
                                            </p>
                                        </div>
                                    </div>
                                </div>
