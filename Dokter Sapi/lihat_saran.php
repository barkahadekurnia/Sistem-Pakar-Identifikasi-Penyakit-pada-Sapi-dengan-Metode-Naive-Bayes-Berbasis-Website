...
$result = mysqli_query($koneksi, "SELECT * FROM saran");

$query = " SELECT * FROM saran ";

if (!isset($_GET['saran_berhasil_dihapus'])) {
    $saran_berhasil_dihapus = 0;
} else {
    $saran_berhasil_dihapus = $_GET['saran_berhasil_dihapus'];
}
?>
...
<body class="hold-transition sidebar-mini">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <?php if ($_SESSION['level'] == 'Administrator') : ?>
                                ...
                                <li class="nav-item">
                                    <a href="lihat_saran.php" class="nav-link active">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Lihat Saran</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">Daftar Saran</h2>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 100px;">Saran</th>
                                                <th>Nama Pengirim</th>
                                                <th>Email Pengirim</th>
                                                <th>Tangal Dikirim</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($data = mysqli_fetch_assoc($result)) : ?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $data["saran"]; ?>
                                                    </td>
                                                    <td><?php echo $data["nama"]; ?></td>
                                                    <td><?php echo $data["email"]; ?></td>
                                                    <td><?php echo $data["waktu_tambah"]; ?></td>

                                                    <td class="text-right py-0 align-middle">
                                                        <div class="btn-group btn-group-sm">
                                                            <!-- <a data-toggle="tooltip" data-placement="top" title="Lihat Data Saran" href="detail_saran.php?id=<?= $data["id"]; ?>" class="btn btn-success">
                                                                <i class="fas fa-eye"></i>
                                                                Lihat</a> -->
                                                            <!-- <a data-toggle="tooltip" data-placement="top" title="Ubah Data Saran" href="ubah_saran.php?id=<?= $data["id"]; ?>" class="btn btn-warning">
                                                                <i class="fas fa-edit"></i>
                                                                Ubah</a> -->
                                                            <a data-toggle="tooltip" data-placement="top" title="Hapus Data Saran" href="aksi/hapus_saran.php?id=<?= $data["id"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus?');" class="btn btn-danger">
                                    ...
                                    <!-- <a href="tambah_saran.php">
                                        <button class="btn btn-info">Tambah Saran</button>
                                    </a> -->
                                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var saran_berhasil_dihapus = <?php echo json_encode($saran_berhasil_dihapus); ?>;
            if (saran_berhasil_dihapus > 0) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Saran telah berhasil Hapus, Terimakasih!'
                    })
                });
            }
        });
