                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="aksi/ubah_artikel.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <input type="hidden" name="id" value=" <?= $data["id"]; ?> ">
                                        <input type="hidden" name="kode_artikel" value="<?= $data["kode_artikel"]; ?>">
                                        <input type="hidden" name="gambarLama" value="<?= $data["gambar"]; ?>">
                                        <input type="hidden" name="nama_penulis" value="<?= $data["nama_penulis"]; ?>">
                                        <input type="hidden" name="waktu_lama" value="<?= $data["waktu_tambah"]; ?>">

                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right" for="judul_artikel">Judul Artikel :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="judul_artikel" id="judul_artikel" placeholder="Nama Penyakit" required value="<?= $data["judul_artikel"]; ?> ">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right" for="no_hp">Sampul Artikel Saat ini:</label>
                                            <div class="col-sm-9">
                                                <img style="height:150px;" src="images/artikel/<?= $data["gambar"]; ?> " onerror="this.src='images/no_image.png'">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-0">
                                            <label class="col-sm-3 text-right" class="col-sm-3 text-right" for="gambar">Ubah Sampul Artikel : </label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea required class="textarea" placeholder="Isi Penyakit..." name="isi_artikel" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                             <?= $data["isi_artikel"]; ?> 
                                            </textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-sm-12">
                                                    ...
                                                    <button type="submit" name="submit" class="btn btn-info float-left">Ubah Artikel</button>
