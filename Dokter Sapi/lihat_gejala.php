...
if (!isset($_GET['gejala_berhasil_ditambah'])) {
    $gejala_berhasil_ditambah = 0;
} else {
    $gejala_berhasil_ditambah = $_GET['gejala_berhasil_ditambah'];
}

if (!isset($_GET['gejala_berhasil_diubah'])) {
    $gejala_berhasil_diubah = 0;
} else {
    $gejala_berhasil_diubah = $_GET['gejala_berhasil_diubah'];
}

if (!isset($_GET['gejala_berhasil_dihapus'])) {
    $gejala_berhasil_dihapus = 0;
} else {
    $gejala_berhasil_dihapus = $_GET['gejala_berhasil_dihapus'];
}
...
//eksp cari nilai max id
// $idmax = QUERY("SELECT * from gejala where id in (SELECT max(id) from gejala)")[0];
...
<body class="hold-transition sidebar-mini">
                            ...
                            <?php else : ?>
                                ...
                                <li class="nav-item has-treeview menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="lihat_gejala.php" class="nav-link active">
                                                <i class="fas fa-list-ul nav-icon" style="font-size: 14px;"></i>
                                                <p style="font-size: 15.5px;">
                                                    Lihat Daftar Gejala
                                                </p>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Lihat Gejala</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($data = mysqli_fetch_assoc($result)) : ?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $data["kode_gejala"]; ?>
                                                    </td>
                                                    <td><?php echo $data["nama_gejala"]; ?></td>
                                                    <td><?php echo $data["keterangan"]; ?></td>
                                                    <!-- <td><img src="images/gejala/<?= $data["gambar"]; ?>" width="50"></td> -->
                                                    <td class="text-right py-0 align-middle">
                                                        <div class="btn-group btn-group-sm">
                                                            <a data-toggle="tooltip" data-placement="top" title="Lihat Data Gejala" href="detail_gejala.php?id=<?= $data["id"]; ?>" class="btn btn-success">
                                                                <i class="fas fa-eye"></i>
                                                                Lihat</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Ubah Data Gejala" href="ubah_gejala.php?id=<?= $data["id"]; ?>" class="btn btn-warning">
                                                                <i class="fas fa-edit"></i>
                                                                Ubah</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Hapus Data Gejala" href="aksi/hapus_gejala.php?id=<?= $data["id"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus?');" class="btn btn-danger">
                                    ...
                                    <a href="tambah_gejala.php">
                                        <button class="btn btn-info">Tambah Gejala</button>
                                    </a>
                                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var gejala_berhasil_ditambah = <?php echo json_encode($gejala_berhasil_ditambah); ?>;
            if (gejala_berhasil_ditambah > 0) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data Gejala Berhasil Ditambahkan, Terimakasih!'
                    })
                });
            }

            var gejala_berhasil_diubah = <?php echo json_encode($gejala_berhasil_diubah); ?>;
            if (gejala_berhasil_diubah > 0) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data Gejala Berhasil DiUbah, Terimakasih!'
                    })
                });
            }

            var gejala_berhasil_dihapus = <?php echo json_encode($gejala_berhasil_dihapus); ?>;
            if (gejala_berhasil_dihapus > 0) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data Gejala Berhasil Dihapus, Terimakasih!'
                    })
                });
            }
        });
