                            ...
                            <?php if ($_SESSION['level'] == 'Administrator') : ?>
                                ...
                                <li class="nav-item has-treeview menu-open">
                                    ...
                                    <ul class="nav nav-treeview ">
                                        <li class="nav-item">
                                            <a href="tambah_pakar.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Tambah Data Pakar</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Tambah Data Pakar</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-sm-12">
                            <div class="card card-info">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Tambah Data Pakar</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <div class="card-body">
                                    <form class="form-horizontal" role="form" action="aksi/tambah_pakar.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right" for="nama">Nama Pakar:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Pakar" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <input type="text" hidden name="level" value="Pakar">
                                        ...
                                        <div class=" card-footer">
                                            <div class="row justify-content-center">
                                                <button type="submit" name="submit" class="btn btn-info">Tambah Pakar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
