                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="lihat_pakar.php">Lihat Pakar</a></li>
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body overflow-hidden" style="height: 420px;">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="ubah_pakar.php?id=<?= $data["id"]; ?>" class=" text-center btn btn-info">
                                    ...
                                    <div class="row overflow-auto">
                                        <div class="col-md-12 col-sm-12" style="text-align:left; height: 290px">
                                            <table class="table justify-content-center" style="width: 100%; height: 100%;">
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-2" style="border-left: 0px !important">Username</td>
                                                    <td class="col-md-9 col-xl-10" style="border-right: 0px !important"><?php echo $data['username']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-2" style="border-left: 0px !important">Nama Pakar</td>
                                                    <td class="col-md-9 col-xl-10" style="border-right: 0px !important"><?php echo $data['nama']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-2" style="border-left: 0px !important">Email</td>
                                                    <td class="col-md-9 col-xl-10" style="border-right: 0px !important"><?php echo $data['email']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-2" style="border-left: 0px !important">No Hp</td>
                                                    <td class="col-md-9 col-xl-10" style="border-right: 0px !important"><?php echo $data['no_hp']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-2" style="border-left: 0px !important">Alamat</td>
                                                    <td class="col-md-9 col-xl-10" style="border-right: 0px !important"><?php echo $data['alamat']; ?></td>
                                                </tr>
                                                <tr>
                                            </table>
                                        </div>
