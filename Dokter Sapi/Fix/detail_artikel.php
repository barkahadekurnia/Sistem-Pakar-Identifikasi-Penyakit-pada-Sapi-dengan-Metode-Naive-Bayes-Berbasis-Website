                        ...
                        <div class=col-12>
                            <div class="card card-info">
                                ...
                                <div class="card-body  mb-3">
                                    <div>
                                        <p class="text-muted"><i class="fas fa-newspaper"></i> &nbsp;&nbsp;<?= $data["kode_artikel"]; ?></p>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid" style="width: 300px;" src="images/artikel/<?= $data["gambar"]; ?>">
                                        </div>
                                        <p class="text-center"><?= $data["judul_artikel"]; ?></p>
                                    </div>
                                </div>
                            </div>
