    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                <img src="images/favicon-32x32.png" alt="dosa Logo" class="brand-image img-circle elevation-3" style="opacity: 1">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr class="h6">
                                                ...
                                                <th style="width: 120px;">Level Pengguna</th>
                                                <th>Username</th>
                                                <th>Nama</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        <div class="btn-group btn-group-sm">
                                                            <a data-toggle="tooltip" data-placement="top" title="Lihat Data Pengguna" href="detail_pengguna.php?id=<?= $data["id"]; ?>" class="btn btn-success">
                                                                <i class="fas fa-eye"></i>
                                                                Lihat</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Ubah Data Pengguna" href="ubah_pengguna.php?id=<?= $data["id"]; ?>" class="btn btn-warning">
                                                                <i class="fas fa-edit"></i>
                                                                Ubah</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Hapus Data Pengguna" href="aksi/hapus_pengguna.php?id=<?= $data["id"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus?');" class="btn btn-danger">
                                    ...
                                    <a href=" tambah_pengguna.php">
                                        <button class="btn btn-info">Tambah Pengguna</button>
                                    </a>
                                </div>
