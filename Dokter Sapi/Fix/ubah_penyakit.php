                                ...
                                <form class="form-horizontal" role="form" action="aksi/ubah_penyakit.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <img style="height:200px;" src="images/penyakit/<?= $data_penyakit["gambar"]; ?>" onerror="this.src='images/no_image.png'">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-center">
                                                <button type="submit" name="submit" class="btn btn-info float-right">Ubah Penyakit</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
