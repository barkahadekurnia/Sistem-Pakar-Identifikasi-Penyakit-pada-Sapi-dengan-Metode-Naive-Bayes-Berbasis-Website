                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body overflow-hidden" style="height: 420px;">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid" style="width:auto;height:300px" src="images/pengguna/<?= $data["gambar"]; ?>" onerror="this.src='images/no_image.png'">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12" style="text-align:left; height: 290px">
                                            <table class="table justify-content-center" style="width: 100%; height: 100%;">
                                                <tr class="row">
                                                    <td class="col-md-2" style="border-left: 0px !important">Nama Pengguna</td>
                                                    <td class="col-md-10 col-lg-10 col-xs-12" style="border-right: 0px !important"><?php echo $data['username']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-2" style="border-left: 0px !important">Nama Lengkap</td>
                                                    <td class="col-md-10 col-lg-10 col-xs-12" style="border-right: 0px !important"><?php echo $data['nama']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-2" style="border-left: 0px !important">Alamat</td>
                                                    <td class="col-md-10 col-lg-10 col-xs-12" style="border-right: 0px !important"><?php echo $data['alamat']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-2" style="border-left: 0px !important">Email</td>
                                                    <td class="col-md-10 col-lg-10 col-xs-12" style="border-right: 0px !important"><?php echo $data['email']; ?></td>
                                                </tr>
                                                <tr>
                                            </table>
                                        </div>
