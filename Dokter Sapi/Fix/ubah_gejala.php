                                ...
                                <form role="form" action="aksi/ubah_gejala.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <img style="height:200px;" src="images/gejala/<?= $data["gambar"]; ?> " onerror="this.src='images/no_image.png'">
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-center">
                                                <button type="submit" name="submit" class="btn btn-info float-right">Ubah Gejala</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
