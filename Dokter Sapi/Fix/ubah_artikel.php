                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Data Artikel</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="aksi/ubah_artikel.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <img style="height:200px;" src="images/artikel/<?= $data["gambar"]; ?> " onerror="this.src='images/no_image.png'">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-center">
                                                <button type="submit" name="submit" class="btn btn-info float-right">Ubah Artikel</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
