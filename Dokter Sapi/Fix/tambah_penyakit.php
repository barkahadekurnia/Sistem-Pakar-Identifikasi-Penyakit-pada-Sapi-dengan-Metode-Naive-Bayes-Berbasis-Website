                                ...
                                <form role="form" action="aksi/tambah_penyakit.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="nama_latin" id="nama_latin" placeholder="Nama Latin" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-center">
                                                <div class="">
                                                    <button type="submit" name="submit" class="btn btn-info float-right ">Tambah Penyakit</button>
                                                </div>
                                            </div>
                                        </div>
                                </form>
