                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <!-- form start -->
                                <div class="card-body">
                                    <form class="form-horizontal" role="form" action="aksi/ubah_pengguna.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <img style="height:200px;" src="images/pengguna/<?= $data["foto"]; ?>">
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="custom-select" required id="level" name="level">
                                                    ...
                                                    ?>
                                                    <!-- <option value="">Lewati Jika Tidak Diubah</option> -->
