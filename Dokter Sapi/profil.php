                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body overflow-hidden" style="height: 420px;">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid" style="width:auto;height:300px" src="images/pengguna/<?= $data["foto"]; ?>" onerror="this.src='images/no_image.png'">
                                    </div>
                                    <!-- <h3 class="profile-username text-center">Gejala</h3>
                                    <p class="text-muted text-center">Detail</p> -->
                                    <div class="text-center mt-3">
                                        <a href="ubah_profil.php?id=<?= $data["id"]; ?>" class=" text-center btn btn-info">
                            ...
                            <div class="card card-info ">
                                ...
                                <div class="card-body" style="height: 420px;">
                                    <div class="row overflow-auto">
                                        <div class="col-md-12 col-sm-12" style="text-align:left; height: 290px">
                                            <table class="table justify-content-center" style="width: 100%; height: 100%;">
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-3" style="border-left: 0px !important">
                                                        Username</td>
                                                    <td class="col-md-9 col-xl-9" style="border-right: 0px !important"><?php echo $data['username']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-3" style="border-left: 0px !important"><?php if ($_SESSION['level'] == 'Administrator') {
                                                                                                                            echo "Nama Administrator";
                                                                                                                        } else {

                                                                                                                            echo "Nama pakar";
                                                                                                                        } ?></td>
                                                    <td class="col-md-9 col-xl-9" style="border-right: 0px !important"><?php echo $data['nama']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-3" style="border-left: 0px !important">Email</td>
                                                    <td class="col-md-9 col-xl-9" style="border-right: 0px !important"><?php echo $data['email']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-3" style="border-left: 0px !important">No Hp</td>
                                                    <td class="col-md-9 col-xl-9" style="border-right: 0px !important"><?php echo $data['no_hp']; ?></td>
                                                </tr>
                                                <tr class="row">
                                                    <td class="col-md-3 col-xl-3" style="border-left: 0px !important">Alamat</td>
                                                    <td class="col-md-9 col-xl-9" style="border-right: 0px !important"><?php echo $data['alamat']; ?></td>
                                                </tr>
                                                <tr>
                                            </table>
                                        </div>
        ...
        $(function() {
            ...
            if (pakar_berhasil_diubah == 1) {
                ...
                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data Profil berhasil Ubah, Terimakasih!'
                    })
                });
            }
            ...
            if (pakar_berhasil_diubah == 2) {
                ...
                $(function() {
                    Toast.fire({
                        icon: 'error',
                        title: 'Data Profil Gagal Ubah, Silahkan Coba Lagi!'
                    })
                });
            }
