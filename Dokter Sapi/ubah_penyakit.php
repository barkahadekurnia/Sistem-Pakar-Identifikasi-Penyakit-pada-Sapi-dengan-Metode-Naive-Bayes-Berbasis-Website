                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="lihat_penyakit.php">Lihat Penyakit</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form class="form-horizontal" role="form" action="aksi/ubah_penyakit.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right" for="no_hp">Gambar Lama:</label>
                                            <div class="col-sm-9">
                                                <img style="height:150px;" src="images/penyakit/<?= $data_penyakit["gambar"]; ?>" onerror="this.src='images/no_image.png'">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-0">
                                            <label class="col-sm-3 text-right" class="col-sm-3 text-right" for="gambar"> Ubah Gambar Penyakit : </label>
                                                                ...
                                                                <input type="checkbox" class="custom-control-input" name="gejala[]" id="<?php echo $gejala['kode_gejala']; ?>" value="<?php echo $gejala['kode_gejala']; ?>" <?php $cek_gejala = $gejala['kode_gejala'];
                                                                                                                                                                                                                                if (isset($gejalanya)) {
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    if (in_array($cek_gejala, $gejalanya)) {
                                                                                                                                                                                                                                        $checked = 'checked'; //ngecentang gejala yg dah di set
                                                                                                                                                                                                                                        echo $checked;
                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                } ?>>
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-sm-12">
                                                    <a href="lihat_penyakit.php">
                                                        <button type="button" class="btn btn-secondary float-right">Batal Ubah</button>
                                                    </a>
                                                    <button type="submit" name="submit" class="btn btn-info float-left">Ubah Data Penyakit</button>
                                                </div>
                                            </div>
                                        </div>
                                </form>
