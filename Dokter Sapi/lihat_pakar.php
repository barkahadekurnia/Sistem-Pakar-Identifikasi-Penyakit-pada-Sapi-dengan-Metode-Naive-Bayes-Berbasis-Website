...
if (!isset($_GET['pakar_berhasil_ditambah'])) {
    $pakar_berhasil_ditambah = 0;
} else {
    $pakar_berhasil_ditambah = $_GET['pakar_berhasil_ditambah'];
}
...
if (!isset($_GET['pakar_berhasil_dihapus'])) {
    $pakar_berhasil_dihapus = 0;
} else {
    $pakar_berhasil_dihapus = $_GET['pakar_berhasil_dihapus'];
}
...
<body class="hold-transition sidebar-mini">
                            ...
                            <?php if ($_SESSION['level'] == 'Administrator') : ?>
                                ...
                                <li class="nav-item has-treeview menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="lihat_pakar.php" class="nav-link active">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Lihat Pakar</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysqli_query($koneksi, "SELECT * FROM pengguna WHERE kode_level='Pakar'");
                                            $i = 1;
                                            while ($data = mysqli_fetch_assoc($result)) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right py-0 px-2 align-middle">
                                                        <div class="btn-group btn-group-sm">
                                                            <a data-toggle="tooltip" data-placement="top" title="Lihat Data Pakar" href="detail_pakar.php?id=<?= $data["id"]; ?>" class="btn btn-success">
                                                                <i class="fas fa-eye"></i>
                                                                Lihat</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Ubah Data Pakar" href="ubah_pakar.php?id=<?= $data["id"]; ?>" class="btn btn-warning">
                                                                <i class="fas fa-edit"></i>
                                                                Ubah</a>
                                                            <a data-toggle="tooltip" data-placement="top" title="Hapus Data Pakar" href="aksi/hapus_pakar.php?id=<?= $data["id"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus?');" class="btn btn-danger">
                                    ...
                                    <a href="tambah_pakar.php">
                                        <button class="btn btn-info">Tambah Pakar</button>
                                    </a>
                                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var pakar_berhasil_ditambah = <?php echo json_encode($pakar_berhasil_ditambah); ?>;
            if (pakar_berhasil_ditambah == 1) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data pakar berhasil tambahkan, Terimakasih!'
                    })
                });
            }

            var pakar_berhasil_diubah = <?php echo json_encode($pakar_berhasil_diubah); ?>;
            if (pakar_berhasil_diubah == 1) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data pakar berhasil Ubah, Terimakasih!'
                    })
                });
            }
            ...
            if (pakar_berhasil_diubah == 2) {
                ...
                $(function() {
                    Toast.fire({
                        icon: 'error',
                        title: 'Data Pakar Gagal diUbah, Silahkan Coba Lagi!'
                    })
                });
            }

            var pakar_berhasil_dihapus = <?php echo json_encode($pakar_berhasil_dihapus); ?>;
            if (pakar_berhasil_dihapus == 2) {

                $(function() {
                    Toast.fire({
                        icon: 'error',
                        title: 'Data Pakar Gagal Dihapus, Anda tidak bisa menghapus Administrator ,Terimakasih !'
                    })
                });
            }

            var pakar_berhasil_dihapus = <?php echo json_encode($pakar_berhasil_dihapus); ?>;
            if (pakar_berhasil_dihapus == 1) {

                $(function() {
                    Toast.fire({
                        icon: 'success',
                        title: 'Data pakar berhasil Hapus, Terimakasih!'
                    })
                });
            }
