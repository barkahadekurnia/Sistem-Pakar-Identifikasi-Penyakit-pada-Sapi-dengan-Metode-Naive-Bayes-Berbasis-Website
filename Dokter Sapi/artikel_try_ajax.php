                                    ...
                                    <div class="container-fluid">
                                        <div class="row content">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <?php
                                                    $sql_artikel = mysqli_query($koneksi, "SELECT *, DATE_FORMAT(waktu_tambah,'%e %M %Y') AS waktu_tambah FROM artikel LIMIT 5 ");
                                                    $sn = 1;
                                                    while ($row = mysqli_fetch_assoc($sql_artikel)) {    ?>
                                                        <div class="col-sm-3">
                                                            <div class="well" id="<?php echo $row['kode_artikel']; ?>">
                                                                <h4><?= $sn++ ?> : <?= $row['isi_artikel'] ?></h4>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                                </div>
                                    ...
                                    <script type="text/javascript">
                                        $(window).scroll(function() {
                                            if ($(window).scrollTop() + $(window).height() >= $(document).height()) {
                                                var lastId = $(".well:last").attr("kode_artikel");
                                                $.ajax({
