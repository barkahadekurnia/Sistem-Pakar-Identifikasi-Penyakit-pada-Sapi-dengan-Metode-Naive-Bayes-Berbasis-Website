                                ...
                                <form role="form" action="aksi/tambah_gejala.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group col-3">
                                            ...
                                            <input type="text" class="form-control" name="nama_gejala" id="nama_gejala" placeholder="Nama Gejala">
                                        </div>
                                        <div class="form-group col-3">
                                            <label for="keterangan">Keterangan:</label>
                                            <textarea type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan Gejala"></textarea>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="submit" class="btn btn-info">Tambah Gejala</button>
                                        </div>
                                </form>
                            </div>
