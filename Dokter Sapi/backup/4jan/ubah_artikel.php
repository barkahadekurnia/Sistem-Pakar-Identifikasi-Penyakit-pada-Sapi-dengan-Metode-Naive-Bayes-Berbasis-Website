                                ...
                                <form role="form" action="aksi/ubah_artikel.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group col-3">
                                            ...
                                            <input type="text" class="form-control" name="judul_artikel" id="judul_artikel" placeholder="Judul artikel" required value="<?= $data["judul_artikel"]; ?>">
                                        </div>
                                        <div class=" form-group col-2">
                                            <div class="input-file">
                                                <label for="gambar">Sampul Artikel: </label>
                                        ...
                                        <div class="form-group col-auto">
                                            ...
                                            <textarea class="textarea" placeholder="Isi Artikel..." name="isi_artikel" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>
                                             <?= $data["isi_artikel"]; ?>
                                            </textarea>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="submit" class="btn btn-info">Ubah Artikel</button>
                                        </div>
                                </form>
                            </div>
