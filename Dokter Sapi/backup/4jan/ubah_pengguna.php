                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="aksi/ubah_pengguna.php" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value=" <?= $data["id"]; ?> ">
                                    <input type="hidden" name="fotoLama" value="<?= $data["foto"]; ?>">
                                    <div class="card-body">
                                        <div class="form-group col-3">
                                            <label for="username">Nama Pengguna:</label>
                                            <input type="text" class="form-control" name="username" id="username" placeholder="Nama Pengguna" required value="<?= $data["username"]; ?>" disabled>
                                        </div>
                                        <div class="form-group col-3">
                                            <label for="password">Kata Sandi:</label>
                                            <input type="password" class="form-control" name="password" id="password" placeholder="Kata Sandi" required value="<?= $data["password"]; ?>">
                                        </div>
                                        <div class="form-group col-3">
                                            <label for="password2">Konfirmasi Kata Sandi:</label>
                                            <input type="password" class="form-control" name="password2" id="password2" placeholder="Konfirmasi Kata Sandi" required value="<?= $data["password"]; ?>">
                                        </div>
                                        <div class="form-group col-3">
                                        ...
                                        <div class="form-group col-3">
                                            <label for="level">Pilih Level Pengguna:</label>
                                            <select class="custom-select" required id="level" name="level">
                                                <option value="<?= $data["email"]; ?>">Lewati Jika Tidak Diubah</option>
                                        ...
                                        <div class=" card-footer">
                                            <button type="submit" name="submit" class="btn btn-info">Ubah Pengguna</button>
                                        </div>
                                </form>
                            </div>
