...
<body class="hold-transition sidebar-mini link">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        <img src="images/dokter-sapi.png" alt="dosa Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
