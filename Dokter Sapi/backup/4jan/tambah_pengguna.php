                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="aksi/tambah_pengguna.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <!-- <div hidden class="form-group col-3">
                                            ...
                                            <input type="text" cl ass="form-control" name="level" id="level" placeholder="level">
                                        </div> -->
                                        <div class="form-group col-3">
