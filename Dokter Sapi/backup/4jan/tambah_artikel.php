                                ...
                                <form role="form" action="aksi/tambah_artikel.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group col-3">
                                            ...
                                            <input type="text" class="form-control" name="judul_artikel" id="judul_artikel" placeholder="Nama Artikel">
                                        </div>
                                        ...
                                        <div class="form-group col-auto">
                                            ...
                                            <textarea required class="form-control" name="isi_artikel" id="textarea" style="height: 300px">
                                            Isi Artikel...
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="submit" class="btn btn-info">Tambah Artikel</button>
                                        </div>
                                </form>
                            </div>
