...
$sql_join = ("
    SELECT gejala.nama_gejala gejala.kode_gejala
    FROM gejala 
...
while ($join = mysqli_fetch_array($q_join)) {
    $nama_gej[] = $join['nama_gejala'];
    $kode_gej[] = $join['nama_gejala'];
}
// var_dump($gej);
                                                ...
                                                while ($gejala = mysqli_fetch_array($q_gejala)) {
                                                    ...
                                                    <tr class="custom-control custom-switch custom-switch-off custom-switch-on-info">
                                                        ...
                                                        <td style="padding: 5px;">
                                                            <input type="checkbox" class="custom-control-input" name="gejala[]" id="<?php echo $gejala['kode_gejala']; ?>" value="<?php echo $gejala['kode_gejala']; ?>" <?php $cek_gejala = $gejala['kode_gejala']; ?> <?php
